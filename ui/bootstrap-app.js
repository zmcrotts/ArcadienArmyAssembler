...
try {
  ...
  document.documentElement.dataset.theme = theme === "custom" ? "dark" : theme;
  document.documentElement.dataset.customTheme = theme === "custom" ? "true" : "false";
  if (theme === "custom") applyBootCustomTheme();
} catch {
