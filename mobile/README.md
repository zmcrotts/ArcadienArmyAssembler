...
The mobile web app is published from `main` to Cloudflare Pages and GitHub Pages. On a supported iPhone or iPad, open [https://arcadienarmyassembler.pages.dev/](https://arcadienarmyassembler.pages.dev/) in Safari, choose **Add to Home Screen** and **Open as Web App**, then use **Download for offline use**. Do not rely on the app away from a connection until it reports **Offline ready**.
